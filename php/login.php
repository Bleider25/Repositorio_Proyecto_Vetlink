...
<meta charset="UTF-8">
    ...
    <link href="../css/crud/login.css" rel="stylesheet">
...
<body>
    <div class="d-flex justify-content-center align-items-center vh-100">
        <form method="post"> 
            ...
            <p class="text-center">¿No tienes cuenta? <a href="registrar.php">Regístrate</a> gratis!</p>

            <p style="text-align: center;"><a href="admin_login.php">Iniciar sesión como administrador</a></p>
